...
class dataProjectExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithTitle
{
    protected $data;
    ...
    public function headings(): array
    {
        return [
            ...
            'poValue' => 'PO Value',
            'projectValuePPN' => 'Project Value',
            'planMandays' => 'Type Plan Mandays',
            'mandaysPlan' => 'Plan Mandays',
