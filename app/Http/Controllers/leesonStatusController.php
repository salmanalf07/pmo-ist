...
class leesonStatusController extends Controller
{
    public function json()
    {
        $data = leesonStatus::orderBy('created_at', 'DESC');
    ...
    {
        $get = leesonStatus::find($request->id);
