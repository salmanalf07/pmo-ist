                    ...
                    <div class="card-body">
                        ...
                        <div class="collapse show" id="task{{$key}}">
                            <div id="detail{{$key}}" class="p-2 mt-4">
                                ...
                                @if ($communitys->categoryId == $categorys->id)
                                <div class="row mb-2 border-bottom pb-2 g-0">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check custom-checkbox ">
                                                <label class="form-check-label" for="customCheck1">
                                                    <span class="h5">{{$communitys->documentName}} </span>
                                    ...
                                    <div class="col-lg-6 ms-5 ms-lg-0 mt-2 mt-lg-0">
                                        <div class="d-flex justify-content-between">
                                            <span class="ms-4">{{$communitys->types->type}}</span>
                                            <span class="me-10">
                                                <a target="_blank" href="{{$communitys->link}}" class="btn btn-ghost btn-icon btn-sm rounded-circle ms-3" data-bs-toggle="tooltip" data-placement="top" title="Link">
