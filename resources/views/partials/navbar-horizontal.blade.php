        ...
        <nav class="navbar navbar-expand-lg navbar-default navbar-dropdown p-0 py-lg-2">
            ...
            <div class="collapse navbar-collapse  px-6 px-lg-0" id="navbar-default">
                <ul class="navbar-nav ms-2">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link {{ request()->is('employee','empByAssignment','empExtResources') ? 'active' : '' }} dropdown-toggle" href="#" id="navbarPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Resources
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarPages">
