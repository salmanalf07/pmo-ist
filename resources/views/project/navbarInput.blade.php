                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div class="card rounded-bottom rounded-0 smooth-shadow-sm mb-5">
                        ...
                        <ul class="nav nav-lt-tab px-4" id="pills-tab" role="tablist">
                            ...
                            <li class=" nav-item">
                                <a class="nav-link {{ request()->is( 'project/projectTimeline*','project/changeprojectTimeline*') ? 'active' : '' }}" href="{{ isset($id) ? '/project/projectTimeline/' . $id : '#' }}">Project</a>
                            </li>
                            <!-- <li class=" nav-item">
                            ...
                            <li class=" nav-item">
                                <a class="nav-link {{ request()->is('project/moms*','project/formMoms*','project/editMom/*') ? 'active' : '' }}" href="{{ isset($id) ? '/project/moms/' . $id : '#' }}">MOM</a>
                            </li>
                            <!-- <li class=" nav-item">
