    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-md-flex border-bottom-0">
                @canany(['bisa-tambah','weekly-editor'])
                <div class="flex-grow-1">
                    <a class="btn btn-primary" href="/project/formWeeklyReport/{{$id}}">Add New</a>
                </div>
                @endcanany
            </div>
            <div class="card-body">
...
<script>
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        if (confirm('Yakin akan menghapus data ini?')) {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/delete_weeklyReport/' + $(this).data('id'),
                data: {
                    '_token': "{{ csrf_token() }}",
                },
