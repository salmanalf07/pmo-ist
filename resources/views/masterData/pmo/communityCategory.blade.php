                ...
                <form method="post" role="form" id="form-add" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input name="categori" id="categori" type="text" class="form-control" placeholder="Enter Here">
                        </div>
                        <div class="mb-3 col-6">
...
<script>
    ...
    $('.col-12').on('click', '.add', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ url("/pmo/store_commCategory") }}',
            data: fd,
            processData: false,
            contentType: false,
    ...
    $('.col-12').on('click', '.update', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '/pmo/update_commCategory/' + id,
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        if (confirm('Yakin akan menghapus data ini?')) {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/pmo/delete_commCategory/' + $(this).data('id'),
                data: {
                    '_token': "{{ csrf_token() }}",
                },
                success: function(data) {
