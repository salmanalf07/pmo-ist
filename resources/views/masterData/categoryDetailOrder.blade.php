                ...
                <form method="post" role="form" id="form-add" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input name="category" id="category" type="text" class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="mb-3 col-12">
...
<script>
    $(function() {
        ...
        var oTable = $('#example1').DataTable({
            ...
            "columnDefs": [{
                ...
                "targets": [0, 2, 3], // table ke 1
            }, ],
            ajax: {
                url: '/json_categoryOrder'
            },
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        if (confirm('Yakin akan menghapus data ini?')) {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/delete_categoryOrder/' + $(this).data('id'),
                data: {
                    '_token': "{{ csrf_token() }}",
                },
                success: function(data) {
