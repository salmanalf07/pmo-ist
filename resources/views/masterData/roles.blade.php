                ...
                <form method="post" role="form" id="form-add" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input name="roleEmployee" id="roleEmployee" type="text" class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="mb-3 col-6">
    ...
    $(document).on('click', '#edit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                //isi form
                $('#id').val(data.id);
                $('#roleEmployee').val(data.roleEmployee);
