                ...
                <form method="post" role="form" id="form-add" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input name="department" id="department" type="text" class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="mb-3 col-6">
...
<script>
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        if (confirm('Yakin akan menghapus data ini?')) {
            ...
            $.ajax({
                type: 'DELETE',
                url: 'delete_department/' + $(this).data('id'),
                data: {
                    '_token': "{{ csrf_token() }}",
                },
                success: function(data) {
