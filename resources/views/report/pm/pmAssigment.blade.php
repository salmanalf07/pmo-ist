                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row col-5 pt-7 ms-3">
                                    ...
                                    <div class="mb-3 col-3">
                                        <form method="post" role="form" id="form-print" action="/r_pm/exportpmAssigment" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                            @csrf
...
<script>
    $(function() {
        ...
        $('.col-12').on('change', '#pm,#status', function() {
            $('#pmId').val($('#pm').val());
