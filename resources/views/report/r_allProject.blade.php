                                ...
                                <div class="row col-2 pt-7 ms-3">
                                    ...
                                    <div class="mb-3 col-6">
                                        <form method="post" role="form" id="form-print" action="/allProjectExport" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                            ...
                                            <input type="text" id="pmName" name="pmName" hidden>
                                            <input type="text" id="sales" name="sales" hidden>
                                            <input type="text" id="spk" name="spk" hidden>
...
<script>
    $(function() {
        ...
        $('#cust_ids, #pmNames, #saless, #spks').on('change', function() {
