                                ...
                                <div class="row col-5 pt-7 ms-3">
                                    ...
                                    <div class="mb-3 col-3">
                                        <form method="post" role="form" id="form-print" action="r_sales/exportDetailPoBySales" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                            ...
                                            <button id="export" type="submit" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Export PDF" class="btn btn-secondary-soft" style="width:100%">
