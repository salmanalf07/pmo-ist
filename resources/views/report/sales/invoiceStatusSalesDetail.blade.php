                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row col-5 pt-7 ms-3">
                                    ...
                                    <div class="mb-3 col-3">
                                        <form method="post" role="form" id="form-print" action="/r_sales/exportInvoiceStatusSalesDetail" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                            @csrf
                                            ...
                                            <button id="export" type="submit" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Export" class="btn btn-secondary-soft mb-3" style="width:100%">
                                            ...
                                            <button type="submit" formaction="/r_sales/exportExcelInvoiceStatusSalesDetail" class="btn btn-success-soft" style="width:100%" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Export Excel"> <!-- Ubah URL pada formaction sesuai kebutuhan -->
...
<script>
    $(function() {
        var oTable = $('#example1').DataTable({
            ...
            ajax: {
                url: '/r_sales/json_invoiceStatusSalesDetail',
                data: function(d) {
            ...
            columns: [{
                    data: function(row, type) {
                        return row.project.saless ? row.project.saless.name : "";
                    },
                    name: 'project.saless.name'
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (data != null) {
                            return data == '1900-01-01' || data == '1990-01-01' ? "" : moment(data).format('DD-MM-YYYY')
                        }
                    }
                },
                {
